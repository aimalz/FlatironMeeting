...
| [NDEs for discrete (count) data](https://github.com/LFITaskForce/FlatironMeeting/issues/14) | @junstinalsing | People with background knowledge of conditional density estimation + general enthusiasm! | @aimalz | W-F |
...
| summary of available software packages |           | @dfm | @dfm, @johannbrehmer, @dch216, @changhoonhahn, @aimalz  | | 
| Intro to TensorFlow Probability by building a conditional density estimator for discrete counts | @EiffL | @EiffL | @changhoonhahn, @aimalz |  |
| Nuisance hardened data compression/LFI of nuisance marginalized posteriors | @justinalsing | @justinalsing | @aimalz |  |
